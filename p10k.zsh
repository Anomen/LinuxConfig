# Generated by Powerlevel10k configuration wizard on 2025-06-24 at 11:22 EDT.
...
# angled separators, sharp heads, round tails, 2 lines, solid, no frame, dark-ornaments,
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=159
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=159
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=195
