...
s0_next_group_button = Disabled
s0_next_group_key = <Alt>grave
s0_prev_group_button = Disabled
s0_prev_group_key = <Shift><Alt>asciitilde
s0_next_no_popup_button = Disabled
s0_next_no_popup_key = Disabled
s0_prev_no_popup_button = Disabled
s0_prev_no_popup_key = Disabled
...
s0_active_shadow_x_offset = 6
s0_active_shadow_y_offset = 6
s0_inactive_shadow_radius = 13.000000
s0_inactive_shadow_opacity = 0.200000
s0_inactive_shadow_color = #000000ff
s0_inactive_shadow_x_offset = 6
s0_inactive_shadow_y_offset = 6
...
[core]
s0_active_plugins = core;crashhandler;composite;opengl;decor;vpswitch;copytex;compiztoolbox;regex;workspacenames;mousepoll;move;grid;animation;snap;thumbnail;place;session;commands;wall;matecompat;showmouse;resize;neg;imgpng;workarounds;expo;ezoom;staticswitcher;fade;scale;
